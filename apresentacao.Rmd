...
* Investigações:
A investigação dos óbitos infantis e fetais ainda é baixa, especialmente nas regiões Norte e Nordeste, o que dificulta a identificação de fatores de risco e a implementação de medidas de prevenção. 
